class TasksController < ApplicationController
  ...
  def toggle
    if TaskService.toggle_status(@task)
      respond_to do |format|
        format.html { redirect_to tasks_path, notice: status_message }
        format.turbo_stream
      end
    else
      redirect_to tasks_path, alert: "Impossible de changer le statut."
    end
  end
  ...
  # Message de statut après toggle
  def status_message
    @task.done? ? "Tâche marquée comme terminée !" : "Tâche remise en attente."
  end
end
